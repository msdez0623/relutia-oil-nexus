...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    Community: [{
      label: "Demetheria Wiki",
      href: "https://demetheria.fandom.com"
    }, {
      label: "Discord Server",
      href: "#discord"
    }, {
      label: "Roleplay Guide",
      href: "#roleplay"
    }, {
      label: "News & Updates",
      href: "#news"
        ...
        <div className="border-t border-border pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6">
              ...
              <a href="https://demetheria.fandom.com" target="_blank" rel="noopener noreferrer" className="flex items-center text-muted-foreground hover:text-primary transition-colors duration-300">
